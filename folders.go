// Calling folders directory which conatains multiple go source files
package folders

/*
Package uuid provides a pure Go implementation of Universally Unique Identifiers (UUID)
variant as defined in RFC-4122. This package supports both the creation and parsing of
